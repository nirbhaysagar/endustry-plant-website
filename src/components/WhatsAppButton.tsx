...
const WhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed right-4 bottom-24 md:bottom-16 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 z-50 group"
